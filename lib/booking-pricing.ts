...
export const SERVICES: ServiceDef[] = [
  {
    ...
    description: "Professional debris removal and system health check.",
    basePrice: 120,
    features: [
  ...
  },
  {
    id: "roof",
    title: "Roof Cleaning",
    description: "Moss removal and preventative treatment for shingles.",
    basePrice: 140,
    features: [
  ...
  },
  {
    ...
    description: "High-pressure flush to clear underground blockages.",
    basePrice: 75,
    features: [
  ...
  },
  {
    id: "inspect",
    title: "Inspection",
    description: "Comprehensive visual and drone-assisted reporting.",
    basePrice: 90,
    features: [
